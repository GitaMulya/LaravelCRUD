     ...
     <div class="col-10">
      ...
      <form method="post" action="/mahasiswa/{{$mhs->id}}/update">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('NIM') is-invalid @enderror" id="NIM" placeholder="Masukkan NIM" name="NIM" value="{{$mhs->NIM}}">
                @error('NIM')
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('Kelas') is-invalid @enderror" id="Kelas" placeholder="Masukkan Kelas" name="Kelas" value="{{$mhs->Kelas}}">
                @error('Kelas')
                <div class="invalid-feedback">{{$message}}</div>
                @enderror
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('Nilai') is-invalid @enderror" id="Nilai" placeholder="Masukkan Nilai" name="Nilai" value="{{$mhs->Nilai}}">
                @error('Nilai')
                <div class="invalid-feedback">{{$message}}</div>
                @enderror
            </div>
